	...
	<div class="row">
		...
		<div class="rside">
			<form class="lform" method="post" name="login">
				<table>
					<tr>
						<td><h1 class="login-title">STUDENT LOGIN FORM</h1></td>
					</tr>
					<tr>
						<td><input type="text" class="login-input" name="studentid" placeholder="Student ID" required/></td>
					</tr>
					<tr>
				...
				<p class="register">Create an account? <a href="Student-Registration.php">Register here.</a></p>
			</form>
		</div>
	</div>
</body>
