...
<head>
	...
	<link rel="stylesheet" href="Body-Style2.css"/>
				...
				<table>
					...
					<tr>
						<td><input type="submit" value="Administrator" name="btnInstructor" class="access-button3"
							 	   formaction="Admin-Login.php"/></td>
					</tr>
				</table>
				<p class="register">Create an account? <a href="Registration-Form.php">Register here.</a></p>
			</form>
		</div>
	</div>
</body>
