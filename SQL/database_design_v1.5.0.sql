...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 06, 2023 at 02:29 AM
...
(100001, 'aron.ligsay@pup.com', 'aron.ligsay', 'student', 'Ligsay', 'Aron', 'A', 'Jr.'),
...
(300000, 'Programming 1', 100, 'One', NULL, 'Applied  Math', 2000),
(300001, 'Programming 2', 30, '', 300000, '', 1990),
...
(300008, 'Mathematics', 30, '', NULL, '', 0000),
(300009, 'Arts', 30, '', NULL, '', 0000),
(300010, 'Programming 3', 30, '', 300001, '', 0000),
(300011, 'CHMTC', 14, 'Yes', NULL, '1st Quarter 2023', 0000);
...
(500015, 400000, 2000028, NULL, 0, 600013),
(500016, 400013, 2000028, NULL, 0, 600000),
(500017, 400013, 200005, NULL, 0, 600000);
...
--
ALTER TABLE `course`
  MODIFY `course_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=300012;

--
-- AUTO_INCREMENT for table `pool_instructor_details`
--
ALTER TABLE `pool_instructor_details`
  MODIFY `instructor_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=700015;
